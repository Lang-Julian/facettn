...
export const REFERENCES: Reference[] = [
  ...
  {
    id: 'gignac2024',
    authors: 'Meta-Analyse zur Validität selbsteingeschätzter Intelligenz',
    year: '2024',
    title: 'Mirror, Mirror on the Wall: A Meta-Analysis on the Validity of Self-Assessed Intelligence through the Lens of the Multiverse',
    source: 'Journal of Intelligence, 12(9), 81 — 278 Effektstärken, N = 36.833',
    doi: '10.3390/jintelligence12090081',
    usedFor: 'Warum dieser Test keine Begabung feststellt: Selbsteinschätzung und gemessener IQ korrelieren nur zu r = 0,30.',
  },
  {
    id: 'stricker2020',
    authors: 'Stricker, J., Buecker, S., Schneider, M., & Preckel, F.',
    year: '2020',
    title: 'Intellectual giftedness and multidimensional perfectionism: A meta-analytic review',
    source: 'Educational Psychology Review, 32, 391–414',
    doi: '10.1007/s10648-019-09504-1',
    usedFor: 'Trennung von selbstorientiertem und sozial vorgeschriebenem Perfektionismus und ihre unterschiedlichen Folgen.',
  },
  {
    id: 'webb2005',
    authors: 'Webb, J. T., Amend, E. R., Webb, N. E., et al.',
    year: '2005',
    ...
    source: 'Great Potential Press',
    usedFor: 'Verwechslung von Unterforderung mit Aufmerksamkeitsstörung — Grundlage der Anspruchsabhängigkeits-Skala.',
  },
  {
    id: 'goldberg1999',
